...
A printed indulgence in Cambridge University Library contains a small meeting of the general and the particular: standardized words, with [blanks filled in for an individual recipient](#ref-print). An institution could reproduce the form and attach its promise to a person. Printing served established religious authority as well as the arguments directed against it.
