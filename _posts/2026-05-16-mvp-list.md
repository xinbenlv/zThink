...
A bookmark is a name. A trip needs a shape. So each candidate gets pulled into [GBrain](https://gbrain.dev) and enriched until it has enough structure to be ranked against the others:
