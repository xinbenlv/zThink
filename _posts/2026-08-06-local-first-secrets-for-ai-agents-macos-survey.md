...
| [Conjur OSS](https://github.com/cyberark/conjur/releases) | ✅ | ⚠️ values | ✅ | ❌ no OSS read ledger documented | maintained, heavyweight |
...
**Conjur OSS** is still maintained ([v1.24.0 in November 2025](https://github.com/cyberark/conjur/releases/tag/v1.24.0)) and offers policy-as-code, but CyberArk's [Enterprise-vs-Open-Source feature page](https://docs.cyberark.com/secrets-manager-sh/12.5/en/content/get%20started/enterprise_vs_opensource.htm) lists SIEM integration among the features "currently available only in Conjur Enterprise," and I found no documented per-read audit ledger for the open-source edition. (A community answer stating audit support is Enterprise-only is no longer reachable: the CyberArk Commons forum has gone offline, and conjur.org now redirects to Palo Alto Networks following its acquisition of CyberArk.) That keeps Conjur OSS out of C4 for me and leaves a PostgreSQL-backed, enterprise-shaped system for a single Mac. **Keywhiz** is [deprecated and no longer maintained](https://github.com/square/keywhiz#:~:text=this%20project%20is%20now%20deprecated%20and%20no%20longer%20maintained); Square points users to Vault.
...
- CyberArk Conjur: [releases](https://github.com/cyberark/conjur/releases) · [Enterprise vs Open Source features](https://docs.cyberark.com/secrets-manager-sh/12.5/en/content/get%20started/enterprise_vs_opensource.htm) · Square Keywhiz: [archived repo](https://github.com/square/keywhiz)
...
- OWASP: [MCP01:2025 Token Mismanagement](https://github.com/OWASP/www-project-mcp-top-10/blob/main/2025/MCP01-2025-Token-Mismanagement-and-Secret-Exposure.md)
